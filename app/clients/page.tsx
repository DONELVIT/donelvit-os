...
export default async function ClientsPage({searchParams}: {searchParams: Promise<{q?: string; status?: string}>}) {
  ...
  return <div className="space-y-6">
    <header><p className="text-sm font-semibold text-red-700">Контрагенты</p><h1 className="mt-1 text-3xl font-bold">Клиенты</h1><p className="mt-2 text-slate-500">Реестр заказчиков и их связи с проектами, объектами и договорами.</p><Link href="/clients/new" className="mt-4 inline-flex rounded-xl bg-red-700 px-4 py-3 text-white">Добавить клиента</Link></header>
