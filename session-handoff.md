...
- Dependencies installed with user approval: `docxtemplater@3.67.5`, `pizzip@3.2.0`. `npm run typecheck` passed. Local `npm run build` halted only at the known Windows sandbox `spawn EPERM`.
