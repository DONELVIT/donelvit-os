...
export function VerificationWorkspace() {
  ...
  async function uploadFile(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (file.size > 100 * 1024 * 1024) { setMessage("Максимальный размер файла — 100 МБ."); return; }
